...
public class GameScreen implements Screen {
    ...
    private boolean checkIfUserHasClicked() { // checks if user has clicked anywhere
    ...
    private void filterHitObjects() {
        ...
        while (listIterator.hasNext()) { // filters future hit objects into currently rendered
            ...
            if (hitObject.getTime() > timeFromStart + AR_OFFSET) { // after timeframe of being rendered => breaks useless looping
                break;
            }
        }
